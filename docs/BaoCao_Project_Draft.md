...
Kết quả này cũng phản ánh **mức trần thực tế** của kiến trúc BM25 Retriever: để cải thiện, cần thay BM25 bằng Dense Retrieval (DPR) hoặc tăng K để Recall cao hơn.
